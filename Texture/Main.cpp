...
int main()
{
	...
	Texture imageTexture("abstractImage.png", GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
	imageTexture.texUnit(shaderProgram, "tex0", 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// assigns value to uniform; always called after activating shader program
